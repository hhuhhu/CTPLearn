...
char *g_pInstrumentID[] = {futurecode1,futurecode2,futurecode3,futurecode4}; // 行情合约代码列表，中、上、大、郑交易所各选一种
...
TThostFtdcInstrumentIDType g_pTradeInstrumentID = "zn1805";        // 所交易的合约代码
